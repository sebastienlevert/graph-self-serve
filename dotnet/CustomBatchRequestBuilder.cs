...
public class CustomBatchRequestBuilder: BatchRequestBuilderCustom
{
    /// <summary>
    ...
    /// <returns></returns>
    public new Task<BatchResponseContent> PostAsync(BatchRequestContentCustom batchRequestContent, CancellationToken cancellationToken = default, Dictionary<string, ParsableFactory<IParsable>> errorMappings = null)
    {
    ...
    /// <param name="errorMappings">The error mappings for using to handle errors in batch request</param>
    /// <returns></returns>
    public new Task<BatchResponseContentCollectionCustom> PostAsync(BatchRequestContentCollectionCustom batchRequestContentCollection, CancellationToken cancellationToken = default, Dictionary<string, ParsableFactory<IParsable>> errorMappings = null)
    {
        var batchErrorMappings = errorMappings ?? new Dictionary<string, ParsableFactory<IParsable>> {
            {"4XX", ODataError.CreateFromDiscriminatorValue},
            {"5XX", ODataError.CreateFromDiscriminatorValue},
