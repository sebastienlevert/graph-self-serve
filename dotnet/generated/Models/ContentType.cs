...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.DocumentSet? DocumentSet { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.DocumentSet DocumentSet { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"documentSet", n => { DocumentSet = n.GetObjectValue<CustomGraph.Client.Models.DocumentSet>(CustomGraph.Client.Models.DocumentSet.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.DocumentSet>("documentSet", DocumentSet);
