...
#nullable restore
        ...
        public CustomGraph.Client.Models.Importance? Importance { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.Location>? Locations { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.Location> Locations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ResponseStatus? ResponseStatus { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ResponseStatus ResponseStatus { get; set; }
#endif
        /// <summary>The sensitivity property</summary>
        public CustomGraph.Client.Models.Sensitivity? Sensitivity { get; set; }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"locations", n => { Locations = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.Location>(CustomGraph.Client.Models.Location.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"responseStatus", n => { ResponseStatus = n.GetObjectValue<CustomGraph.Client.Models.ResponseStatus>(CustomGraph.Client.Models.ResponseStatus.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.Location>("locations", Locations);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ResponseStatus>("responseStatus", ResponseStatus);
