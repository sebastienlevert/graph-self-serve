...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ResourceReference? ResourceReference { get; private set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ResourceReference ResourceReference { get; private set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ResourceVisualization? ResourceVisualization { get; private set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ResourceVisualization ResourceVisualization { get; private set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"resourceReference", n => { ResourceReference = n.GetObjectValue<CustomGraph.Client.Models.ResourceReference>(CustomGraph.Client.Models.ResourceReference.CreateFromDiscriminatorValue); } },
                {"resourceVisualization", n => { ResourceVisualization = n.GetObjectValue<CustomGraph.Client.Models.ResourceVisualization>(CustomGraph.Client.Models.ResourceVisualization.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
