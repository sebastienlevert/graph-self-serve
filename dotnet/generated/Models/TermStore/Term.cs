...
namespace CustomGraph.Client.Models.TermStore {
    public class Term : CustomGraph.Client.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.KeyValue>? Properties { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.KeyValue> Properties { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.TermStore.Set? Set { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.TermStore.Set Set { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"properties", n => { Properties = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.KeyValue>(CustomGraph.Client.Models.KeyValue.CreateFromDiscriminatorValue)?.ToList(); } },
                {"relations", n => { Relations = n.GetCollectionOfObjectValues<Relation>(Relation.CreateFromDiscriminatorValue)?.ToList(); } },
                {"set", n => { Set = n.GetObjectValue<CustomGraph.Client.Models.TermStore.Set>(CustomGraph.Client.Models.TermStore.Set.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.KeyValue>("properties", Properties);
            writer.WriteCollectionOfObjectValues<Relation>("relations", Relations);
            writer.WriteObjectValue<CustomGraph.Client.Models.TermStore.Set>("set", Set);
        }
    }
}
