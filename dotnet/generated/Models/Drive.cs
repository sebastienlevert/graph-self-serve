...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Quota? Quota { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Quota Quota { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"quota", n => { Quota = n.GetObjectValue<CustomGraph.Client.Models.Quota>(CustomGraph.Client.Models.Quota.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Quota>("quota", Quota);
