...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.EmailAddress? EmailAddress { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.EmailAddress EmailAddress { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"emailAddress", n => { EmailAddress = n.GetObjectValue<CustomGraph.Client.Models.EmailAddress>(CustomGraph.Client.Models.EmailAddress.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.EmailAddress>("emailAddress", EmailAddress);
