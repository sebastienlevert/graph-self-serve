...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Json? Layout { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Json Layout { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"layout", n => { Layout = n.GetObjectValue<CustomGraph.Client.Models.Json>(CustomGraph.Client.Models.Json.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Json>("layout", Layout);
