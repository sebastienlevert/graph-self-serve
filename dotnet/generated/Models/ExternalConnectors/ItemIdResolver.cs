...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ExternalConnectors.UrlMatchInfo? UrlMatchInfo { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ExternalConnectors.UrlMatchInfo UrlMatchInfo { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"urlMatchInfo", n => { UrlMatchInfo = n.GetObjectValue<CustomGraph.Client.Models.ExternalConnectors.UrlMatchInfo>(CustomGraph.Client.Models.ExternalConnectors.UrlMatchInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ExternalConnectors.UrlMatchInfo>("urlMatchInfo", UrlMatchInfo);
        }
    }
}
