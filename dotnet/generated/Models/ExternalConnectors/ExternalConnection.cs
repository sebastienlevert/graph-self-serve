...
namespace CustomGraph.Client.Models.ExternalConnectors {
    public class ExternalConnection : CustomGraph.Client.Models.Entity, IParsable {
        /// <summary>Collects configurable settings related to activities involving connector content.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ExternalConnectors.ActivitySettings? ActivitySettings { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ExternalConnectors.ActivitySettings ActivitySettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ExternalConnectors.Configuration? Configuration { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ExternalConnectors.Configuration Configuration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ExternalConnectors.Schema? Schema { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ExternalConnectors.Schema Schema { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ExternalConnectors.SearchSettings? SearchSettings { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ExternalConnectors.SearchSettings SearchSettings { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"activitySettings", n => { ActivitySettings = n.GetObjectValue<CustomGraph.Client.Models.ExternalConnectors.ActivitySettings>(CustomGraph.Client.Models.ExternalConnectors.ActivitySettings.CreateFromDiscriminatorValue); } },
                {"configuration", n => { Configuration = n.GetObjectValue<CustomGraph.Client.Models.ExternalConnectors.Configuration>(CustomGraph.Client.Models.ExternalConnectors.Configuration.CreateFromDiscriminatorValue); } },
                ...
                {"schema", n => { Schema = n.GetObjectValue<CustomGraph.Client.Models.ExternalConnectors.Schema>(CustomGraph.Client.Models.ExternalConnectors.Schema.CreateFromDiscriminatorValue); } },
                {"searchSettings", n => { SearchSettings = n.GetObjectValue<CustomGraph.Client.Models.ExternalConnectors.SearchSettings>(CustomGraph.Client.Models.ExternalConnectors.SearchSettings.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ExternalConnectors.ActivitySettings>("activitySettings", ActivitySettings);
            writer.WriteObjectValue<CustomGraph.Client.Models.ExternalConnectors.Configuration>("configuration", Configuration);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ExternalConnectors.Schema>("schema", Schema);
            writer.WriteObjectValue<CustomGraph.Client.Models.ExternalConnectors.SearchSettings>("searchSettings", SearchSettings);
        }
    }
}
