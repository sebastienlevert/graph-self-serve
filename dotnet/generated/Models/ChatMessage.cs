...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ChannelIdentity? ChannelIdentity { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ChannelIdentity ChannelIdentity { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"channelIdentity", n => { ChannelIdentity = n.GetObjectValue<CustomGraph.Client.Models.ChannelIdentity>(CustomGraph.Client.Models.ChannelIdentity.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ChannelIdentity>("channelIdentity", ChannelIdentity);
