...
#nullable enable
        public CustomGraph.Client.Models.Call? Call { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Call Call { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"call", n => { Call = n.GetObjectValue<CustomGraph.Client.Models.Call>(CustomGraph.Client.Models.Call.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Call>("call", Call);
