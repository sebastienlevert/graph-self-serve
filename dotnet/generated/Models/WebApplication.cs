...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ImplicitGrantSettings? ImplicitGrantSettings { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ImplicitGrantSettings ImplicitGrantSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.RedirectUriSettings>? RedirectUriSettings { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.RedirectUriSettings> RedirectUriSettings { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"implicitGrantSettings", n => { ImplicitGrantSettings = n.GetObjectValue<CustomGraph.Client.Models.ImplicitGrantSettings>(CustomGraph.Client.Models.ImplicitGrantSettings.CreateFromDiscriminatorValue); } },
                {"logoutUrl", n => { LogoutUrl = n.GetStringValue(); } },
                {"@odata.type", n => { OdataType = n.GetStringValue(); } },
                {"redirectUriSettings", n => { RedirectUriSettings = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.RedirectUriSettings>(CustomGraph.Client.Models.RedirectUriSettings.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ImplicitGrantSettings>("implicitGrantSettings", ImplicitGrantSettings);
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.RedirectUriSettings>("redirectUriSettings", RedirectUriSettings);
