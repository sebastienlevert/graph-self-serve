...
#nullable enable
        public CustomGraph.Client.Models.Hashes? Hashes { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Hashes Hashes { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"hashes", n => { Hashes = n.GetObjectValue<CustomGraph.Client.Models.Hashes>(CustomGraph.Client.Models.Hashes.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Hashes>("hashes", Hashes);
