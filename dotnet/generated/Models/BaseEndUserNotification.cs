...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.EndUserNotification? EndUserNotification { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.EndUserNotification EndUserNotification { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"endUserNotification", n => { EndUserNotification = n.GetObjectValue<CustomGraph.Client.Models.EndUserNotification>(CustomGraph.Client.Models.EndUserNotification.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.EndUserNotification>("endUserNotification", EndUserNotification);
