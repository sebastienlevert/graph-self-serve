...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.AutomaticRepliesSetting? AutomaticRepliesSetting { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.AutomaticRepliesSetting AutomaticRepliesSetting { get; set; }
#endif
...
#nullable restore
        ...
        public CustomGraph.Client.Models.DelegateMeetingMessageDeliveryOptions? DelegateMeetingMessageDeliveryOptions { get; set; }
...
#nullable restore
        ...
        public CustomGraph.Client.Models.UserPurpose? UserPurpose { get; set; }
        /// <summary>The days of the week and hours in a specific time zone that the user works.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.WorkingHours? WorkingHours { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.WorkingHours WorkingHours { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"automaticRepliesSetting", n => { AutomaticRepliesSetting = n.GetObjectValue<CustomGraph.Client.Models.AutomaticRepliesSetting>(CustomGraph.Client.Models.AutomaticRepliesSetting.CreateFromDiscriminatorValue); } },
                ...
                {"workingHours", n => { WorkingHours = n.GetObjectValue<CustomGraph.Client.Models.WorkingHours>(CustomGraph.Client.Models.WorkingHours.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.AutomaticRepliesSetting>("automaticRepliesSetting", AutomaticRepliesSetting);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.WorkingHours>("workingHours", WorkingHours);
