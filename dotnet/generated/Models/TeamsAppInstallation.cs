...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.TeamsApp? TeamsApp { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.TeamsApp TeamsApp { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.TeamsAppDefinition? TeamsAppDefinition { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.TeamsAppDefinition TeamsAppDefinition { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"teamsApp", n => { TeamsApp = n.GetObjectValue<CustomGraph.Client.Models.TeamsApp>(CustomGraph.Client.Models.TeamsApp.CreateFromDiscriminatorValue); } },
                {"teamsAppDefinition", n => { TeamsAppDefinition = n.GetObjectValue<CustomGraph.Client.Models.TeamsAppDefinition>(CustomGraph.Client.Models.TeamsAppDefinition.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.TeamsApp>("teamsApp", TeamsApp);
            writer.WriteObjectValue<CustomGraph.Client.Models.TeamsAppDefinition>("teamsAppDefinition", TeamsAppDefinition);
        }
    }
}
