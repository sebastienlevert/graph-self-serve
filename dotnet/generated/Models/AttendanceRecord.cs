...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Identity? Identity { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Identity Identity { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"identity", n => { Identity = n.GetObjectValue<CustomGraph.Client.Models.Identity>(CustomGraph.Client.Models.Identity.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Identity>("identity", Identity);
