...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.RecordingInfo? RecordingInfo { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.RecordingInfo RecordingInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.RemovedState? RemovedState { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.RemovedState RemovedState { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"recordingInfo", n => { RecordingInfo = n.GetObjectValue<CustomGraph.Client.Models.RecordingInfo>(CustomGraph.Client.Models.RecordingInfo.CreateFromDiscriminatorValue); } },
                {"removedState", n => { RemovedState = n.GetObjectValue<CustomGraph.Client.Models.RemovedState>(CustomGraph.Client.Models.RemovedState.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.RecordingInfo>("recordingInfo", RecordingInfo);
            writer.WriteObjectValue<CustomGraph.Client.Models.RemovedState>("removedState", RemovedState);
