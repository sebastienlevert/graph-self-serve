...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.CallOptions? CallOptions { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.CallOptions CallOptions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ChatInfo? ChatInfo { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ChatInfo ChatInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.IncomingContext? IncomingContext { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.IncomingContext IncomingContext { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.MediaConfig? MediaConfig { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.MediaConfig MediaConfig { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.MeetingInfo? MeetingInfo { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.MeetingInfo MeetingInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ResultInfo? ResultInfo { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ResultInfo ResultInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ToneInfo? ToneInfo { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ToneInfo ToneInfo { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"callOptions", n => { CallOptions = n.GetObjectValue<CustomGraph.Client.Models.CallOptions>(CustomGraph.Client.Models.CallOptions.CreateFromDiscriminatorValue); } },
                {"callRoutes", n => { CallRoutes = n.GetCollectionOfObjectValues<CallRoute>(CallRoute.CreateFromDiscriminatorValue)?.ToList(); } },
                {"callbackUri", n => { CallbackUri = n.GetStringValue(); } },
                {"chatInfo", n => { ChatInfo = n.GetObjectValue<CustomGraph.Client.Models.ChatInfo>(CustomGraph.Client.Models.ChatInfo.CreateFromDiscriminatorValue); } },
                ...
                {"incomingContext", n => { IncomingContext = n.GetObjectValue<CustomGraph.Client.Models.IncomingContext>(CustomGraph.Client.Models.IncomingContext.CreateFromDiscriminatorValue); } },
                {"mediaConfig", n => { MediaConfig = n.GetObjectValue<CustomGraph.Client.Models.MediaConfig>(CustomGraph.Client.Models.MediaConfig.CreateFromDiscriminatorValue); } },
                {"mediaState", n => { MediaState = n.GetObjectValue<CallMediaState>(CallMediaState.CreateFromDiscriminatorValue); } },
                {"meetingInfo", n => { MeetingInfo = n.GetObjectValue<CustomGraph.Client.Models.MeetingInfo>(CustomGraph.Client.Models.MeetingInfo.CreateFromDiscriminatorValue); } },
                ...
                {"resultInfo", n => { ResultInfo = n.GetObjectValue<CustomGraph.Client.Models.ResultInfo>(CustomGraph.Client.Models.ResultInfo.CreateFromDiscriminatorValue); } },
                ...
                {"toneInfo", n => { ToneInfo = n.GetObjectValue<CustomGraph.Client.Models.ToneInfo>(CustomGraph.Client.Models.ToneInfo.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.CallOptions>("callOptions", CallOptions);
            writer.WriteCollectionOfObjectValues<CallRoute>("callRoutes", CallRoutes);
            writer.WriteObjectValue<CustomGraph.Client.Models.ChatInfo>("chatInfo", ChatInfo);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.IncomingContext>("incomingContext", IncomingContext);
            writer.WriteObjectValue<CustomGraph.Client.Models.MediaConfig>("mediaConfig", MediaConfig);
            writer.WriteObjectValue<CallMediaState>("mediaState", MediaState);
            writer.WriteObjectValue<CustomGraph.Client.Models.MeetingInfo>("meetingInfo", MeetingInfo);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ResultInfo>("resultInfo", ResultInfo);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ToneInfo>("toneInfo", ToneInfo);
