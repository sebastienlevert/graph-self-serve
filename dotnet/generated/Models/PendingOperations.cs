...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.PendingContentUpdate? PendingContentUpdate { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.PendingContentUpdate PendingContentUpdate { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"pendingContentUpdate", n => { PendingContentUpdate = n.GetObjectValue<CustomGraph.Client.Models.PendingContentUpdate>(CustomGraph.Client.Models.PendingContentUpdate.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.PendingContentUpdate>("pendingContentUpdate", PendingContentUpdate);
