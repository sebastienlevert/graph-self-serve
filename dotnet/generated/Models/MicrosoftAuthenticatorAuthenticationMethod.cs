...
#nullable enable
        public CustomGraph.Client.Models.Device? Device { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Device Device { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"device", n => { Device = n.GetObjectValue<CustomGraph.Client.Models.Device>(CustomGraph.Client.Models.Device.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Device>("device", Device);
