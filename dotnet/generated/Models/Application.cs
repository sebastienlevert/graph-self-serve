...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Certification? Certification { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Certification Certification { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.OptionalClaims? OptionalClaims { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.OptionalClaims OptionalClaims { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ParentalControlSettings? ParentalControlSettings { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ParentalControlSettings ParentalControlSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.RequestSignatureVerification? RequestSignatureVerification { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.RequestSignatureVerification RequestSignatureVerification { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.RequiredResourceAccess>? RequiredResourceAccess { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.RequiredResourceAccess> RequiredResourceAccess { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ServicePrincipalLockConfiguration? ServicePrincipalLockConfiguration { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ServicePrincipalLockConfiguration ServicePrincipalLockConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Synchronization? Synchronization { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Synchronization Synchronization { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.VerifiedPublisher? VerifiedPublisher { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.VerifiedPublisher VerifiedPublisher { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"certification", n => { Certification = n.GetObjectValue<CustomGraph.Client.Models.Certification>(CustomGraph.Client.Models.Certification.CreateFromDiscriminatorValue); } },
                ...
                {"optionalClaims", n => { OptionalClaims = n.GetObjectValue<CustomGraph.Client.Models.OptionalClaims>(CustomGraph.Client.Models.OptionalClaims.CreateFromDiscriminatorValue); } },
                {"owners", n => { Owners = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"parentalControlSettings", n => { ParentalControlSettings = n.GetObjectValue<CustomGraph.Client.Models.ParentalControlSettings>(CustomGraph.Client.Models.ParentalControlSettings.CreateFromDiscriminatorValue); } },
                ...
                {"requestSignatureVerification", n => { RequestSignatureVerification = n.GetObjectValue<CustomGraph.Client.Models.RequestSignatureVerification>(CustomGraph.Client.Models.RequestSignatureVerification.CreateFromDiscriminatorValue); } },
                {"requiredResourceAccess", n => { RequiredResourceAccess = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.RequiredResourceAccess>(CustomGraph.Client.Models.RequiredResourceAccess.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"servicePrincipalLockConfiguration", n => { ServicePrincipalLockConfiguration = n.GetObjectValue<CustomGraph.Client.Models.ServicePrincipalLockConfiguration>(CustomGraph.Client.Models.ServicePrincipalLockConfiguration.CreateFromDiscriminatorValue); } },
                ...
                {"synchronization", n => { Synchronization = n.GetObjectValue<CustomGraph.Client.Models.Synchronization>(CustomGraph.Client.Models.Synchronization.CreateFromDiscriminatorValue); } },
                ...
                {"verifiedPublisher", n => { VerifiedPublisher = n.GetObjectValue<CustomGraph.Client.Models.VerifiedPublisher>(CustomGraph.Client.Models.VerifiedPublisher.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Certification>("certification", Certification);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.OptionalClaims>("optionalClaims", OptionalClaims);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("owners", Owners);
            writer.WriteObjectValue<CustomGraph.Client.Models.ParentalControlSettings>("parentalControlSettings", ParentalControlSettings);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.RequestSignatureVerification>("requestSignatureVerification", RequestSignatureVerification);
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.RequiredResourceAccess>("requiredResourceAccess", RequiredResourceAccess);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ServicePrincipalLockConfiguration>("servicePrincipalLockConfiguration", ServicePrincipalLockConfiguration);
            writer.WriteStringValue("signInAudience", SignInAudience);
            writer.WriteObjectValue<SpaApplication>("spa", Spa);
            writer.WriteObjectValue<CustomGraph.Client.Models.Synchronization>("synchronization", Synchronization);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.VerifiedPublisher>("verifiedPublisher", VerifiedPublisher);
