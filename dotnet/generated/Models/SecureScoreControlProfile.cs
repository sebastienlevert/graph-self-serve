...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.ComplianceInformation>? ComplianceInformation { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.ComplianceInformation> ComplianceInformation { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"complianceInformation", n => { ComplianceInformation = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.ComplianceInformation>(CustomGraph.Client.Models.ComplianceInformation.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.ComplianceInformation>("complianceInformation", ComplianceInformation);
