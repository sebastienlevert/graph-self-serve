...
#nullable enable
        public CustomGraph.Client.Models.Approval? Approval { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Approval Approval { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"approval", n => { Approval = n.GetObjectValue<CustomGraph.Client.Models.Approval>(CustomGraph.Client.Models.Approval.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Approval>("approval", Approval);
