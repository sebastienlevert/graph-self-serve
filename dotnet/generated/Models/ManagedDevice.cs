...
#nullable restore
        ...
        public CustomGraph.Client.Models.ComplianceState? ComplianceState { get; set; }
        /// <summary>ConfigrMgr client enabled features. This property is read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ConfigurationManagerClientEnabledFeatures? ConfigurationManagerClientEnabledFeatures { get; private set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ConfigurationManagerClientEnabledFeatures ConfigurationManagerClientEnabledFeatures { get; private set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.DeviceCategory? DeviceCategory { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.DeviceCategory DeviceCategory { get; set; }
#endif
...
#nullable restore
        ...
        public CustomGraph.Client.Models.DeviceEnrollmentType? DeviceEnrollmentType { get; set; }
        /// <summary>The device health attestation state. This property is read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.DeviceHealthAttestationState? DeviceHealthAttestationState { get; private set; }
#nullable restore
#else
        public CustomGraph.Client.Models.DeviceHealthAttestationState DeviceHealthAttestationState { get; private set; }
#endif
...
#nullable restore
        ...
        public CustomGraph.Client.Models.DeviceRegistrationState? DeviceRegistrationState { get; set; }
...
#nullable restore
        ...
        public CustomGraph.Client.Models.ManagedDeviceOwnerType? ManagedDeviceOwnerType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.WindowsProtectionState? WindowsProtectionState { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.WindowsProtectionState WindowsProtectionState { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"configurationManagerClientEnabledFeatures", n => { ConfigurationManagerClientEnabledFeatures = n.GetObjectValue<CustomGraph.Client.Models.ConfigurationManagerClientEnabledFeatures>(CustomGraph.Client.Models.ConfigurationManagerClientEnabledFeatures.CreateFromDiscriminatorValue); } },
                ...
                {"deviceCategory", n => { DeviceCategory = n.GetObjectValue<CustomGraph.Client.Models.DeviceCategory>(CustomGraph.Client.Models.DeviceCategory.CreateFromDiscriminatorValue); } },
                ...
                {"deviceHealthAttestationState", n => { DeviceHealthAttestationState = n.GetObjectValue<CustomGraph.Client.Models.DeviceHealthAttestationState>(CustomGraph.Client.Models.DeviceHealthAttestationState.CreateFromDiscriminatorValue); } },
                ...
                {"windowsProtectionState", n => { WindowsProtectionState = n.GetObjectValue<CustomGraph.Client.Models.WindowsProtectionState>(CustomGraph.Client.Models.WindowsProtectionState.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.DeviceCategory>("deviceCategory", DeviceCategory);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.WindowsProtectionState>("windowsProtectionState", WindowsProtectionState);
        }
    }
}
