...
using System.Linq;
using System;
namespace CustomGraph.Client.Models.ODataErrors {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.ODataErrors.InnerError? InnerError { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ODataErrors.InnerError InnerError { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"innerError", n => { InnerError = n.GetObjectValue<CustomGraph.Client.Models.ODataErrors.InnerError>(CustomGraph.Client.Models.ODataErrors.InnerError.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ODataErrors.InnerError>("innerError", InnerError);
