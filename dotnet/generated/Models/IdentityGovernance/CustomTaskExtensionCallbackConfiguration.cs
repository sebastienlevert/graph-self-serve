...
namespace CustomGraph.Client.Models.IdentityGovernance {
    public class CustomTaskExtensionCallbackConfiguration : CustomGraph.Client.Models.CustomExtensionCallbackConfiguration, IParsable {
        /// <summary>The authorizedApps property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.Application>? AuthorizedApps { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.Application> AuthorizedApps { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"authorizedApps", n => { AuthorizedApps = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.Application>(CustomGraph.Client.Models.Application.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.Application>("authorizedApps", AuthorizedApps);
        }
    }
}
