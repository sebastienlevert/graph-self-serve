...
namespace CustomGraph.Client.Models.IdentityGovernance {
    public class TaskReport : CustomGraph.Client.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.IdentityGovernance.TaskDefinition? TaskDefinition { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.IdentityGovernance.TaskDefinition TaskDefinition { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"taskDefinition", n => { TaskDefinition = n.GetObjectValue<CustomGraph.Client.Models.IdentityGovernance.TaskDefinition>(CustomGraph.Client.Models.IdentityGovernance.TaskDefinition.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.IdentityGovernance.TaskDefinition>("taskDefinition", TaskDefinition);
