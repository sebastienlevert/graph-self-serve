...
namespace CustomGraph.Client.Models.IdentityGovernance {
    public class TaskObject : CustomGraph.Client.Models.Entity, IParsable {
...
#nullable enable
        public List<CustomGraph.Client.Models.KeyValuePair>? Arguments { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.KeyValuePair> Arguments { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"arguments", n => { Arguments = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.KeyValuePair>(CustomGraph.Client.Models.KeyValuePair.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.KeyValuePair>("arguments", Arguments);
