...
#nullable enable
        public CustomGraph.Client.Models.SubjectSet? Scope { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.SubjectSet Scope { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"scope", n => { Scope = n.GetObjectValue<CustomGraph.Client.Models.SubjectSet>(CustomGraph.Client.Models.SubjectSet.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.SubjectSet>("scope", Scope);
