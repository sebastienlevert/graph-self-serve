...
namespace CustomGraph.Client.Models.IdentityGovernance {
    public class LifecycleManagementSettings : CustomGraph.Client.Models.Entity, IParsable {
        /// <summary>The emailSettings property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.EmailSettings? EmailSettings { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.EmailSettings EmailSettings { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"emailSettings", n => { EmailSettings = n.GetObjectValue<CustomGraph.Client.Models.EmailSettings>(CustomGraph.Client.Models.EmailSettings.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.EmailSettings>("emailSettings", EmailSettings);
