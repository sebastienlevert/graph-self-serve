...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.Trending>? Trending { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.Trending> Trending { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"trending", n => { Trending = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.Trending>(CustomGraph.Client.Models.Trending.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.Trending>("trending", Trending);
