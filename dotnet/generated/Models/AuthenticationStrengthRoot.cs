...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.AuthenticationMethodModes?>? Combinations { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.AuthenticationMethodModes?> Combinations { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"combinations", n => { Combinations = n.GetCollectionOfEnumValues<CustomGraph.Client.Models.AuthenticationMethodModes>()?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfEnumValues<CustomGraph.Client.Models.AuthenticationMethodModes>("combinations", Combinations);
