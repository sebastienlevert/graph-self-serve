...
#nullable enable
        public CustomGraph.Client.Models.Album? Album { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Album Album { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"album", n => { Album = n.GetObjectValue<CustomGraph.Client.Models.Album>(CustomGraph.Client.Models.Album.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Album>("album", Album);
