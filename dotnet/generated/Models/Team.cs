...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Group? Group { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Group Group { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Schedule? Schedule { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Schedule Schedule { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"group", n => { Group = n.GetObjectValue<CustomGraph.Client.Models.Group>(CustomGraph.Client.Models.Group.CreateFromDiscriminatorValue); } },
                ...
                {"schedule", n => { Schedule = n.GetObjectValue<CustomGraph.Client.Models.Schedule>(CustomGraph.Client.Models.Schedule.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Group>("group", Group);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Schedule>("schedule", Schedule);
