...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.CertificateBasedAuthConfiguration>? CertificateBasedAuthConfiguration { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.CertificateBasedAuthConfiguration> CertificateBasedAuthConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public CustomGraph.Client.Models.PartnerTenantType? PartnerTenantType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.PrivacyProfile? PrivacyProfile { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.PrivacyProfile PrivacyProfile { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"certificateBasedAuthConfiguration", n => { CertificateBasedAuthConfiguration = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.CertificateBasedAuthConfiguration>(CustomGraph.Client.Models.CertificateBasedAuthConfiguration.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"privacyProfile", n => { PrivacyProfile = n.GetObjectValue<CustomGraph.Client.Models.PrivacyProfile>(CustomGraph.Client.Models.PrivacyProfile.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.CertificateBasedAuthConfiguration>("certificateBasedAuthConfiguration", CertificateBasedAuthConfiguration);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.PrivacyProfile>("privacyProfile", PrivacyProfile);
