...
namespace CustomGraph.Client.Models {
    public class AuthorizationPolicy : PolicyBase, IParsable {
        ...
        public CustomGraph.Client.Models.AllowInvitesFrom? AllowInvitesFrom { get; set; }
...
#nullable enable
        public CustomGraph.Client.Models.DefaultUserRolePermissions? DefaultUserRolePermissions { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.DefaultUserRolePermissions DefaultUserRolePermissions { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"defaultUserRolePermissions", n => { DefaultUserRolePermissions = n.GetObjectValue<CustomGraph.Client.Models.DefaultUserRolePermissions>(CustomGraph.Client.Models.DefaultUserRolePermissions.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.DefaultUserRolePermissions>("defaultUserRolePermissions", DefaultUserRolePermissions);
