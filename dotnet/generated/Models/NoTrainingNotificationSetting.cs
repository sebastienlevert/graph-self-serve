...
#nullable enable
        public CustomGraph.Client.Models.SimulationNotification? SimulationNotification { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.SimulationNotification SimulationNotification { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"simulationNotification", n => { SimulationNotification = n.GetObjectValue<CustomGraph.Client.Models.SimulationNotification>(CustomGraph.Client.Models.SimulationNotification.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.SimulationNotification>("simulationNotification", SimulationNotification);
        }
    }
}
