...
#nullable enable
        public List<CustomGraph.Client.Models.UserRegistrationDetails>? UserRegistrationDetails { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.UserRegistrationDetails> UserRegistrationDetails { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"userRegistrationDetails", n => { UserRegistrationDetails = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.UserRegistrationDetails>(CustomGraph.Client.Models.UserRegistrationDetails.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.UserRegistrationDetails>("userRegistrationDetails", UserRegistrationDetails);
        }
    }
}
