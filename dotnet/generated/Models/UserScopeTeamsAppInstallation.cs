...
#nullable enable
        public CustomGraph.Client.Models.Chat? Chat { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Chat Chat { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"chat", n => { Chat = n.GetObjectValue<CustomGraph.Client.Models.Chat>(CustomGraph.Client.Models.Chat.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Chat>("chat", Chat);
        }
    }
}
