...
namespace CustomGraph.Client.Models.Security {
    public class RetentionEvent : CustomGraph.Client.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Security.RetentionEventType? RetentionEventType { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Security.RetentionEventType RetentionEventType { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"retentionEventType", n => { RetentionEventType = n.GetObjectValue<CustomGraph.Client.Models.Security.RetentionEventType>(CustomGraph.Client.Models.Security.RetentionEventType.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Security.RetentionEventType>("retentionEventType", RetentionEventType);
        }
    }
}
