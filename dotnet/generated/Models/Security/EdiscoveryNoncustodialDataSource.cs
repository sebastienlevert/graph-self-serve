...
#nullable enable
        public CustomGraph.Client.Models.Security.DataSource? DataSource { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Security.DataSource DataSource { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"dataSource", n => { DataSource = n.GetObjectValue<CustomGraph.Client.Models.Security.DataSource>(CustomGraph.Client.Models.Security.DataSource.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Security.DataSource>("dataSource", DataSource);
