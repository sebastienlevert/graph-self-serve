...
namespace CustomGraph.Client.Models.Security {
    public class Indicator : CustomGraph.Client.Models.Entity, IParsable {
        /// <summary>The artifact property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Security.Artifact? Artifact { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Security.Artifact Artifact { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"artifact", n => { Artifact = n.GetObjectValue<CustomGraph.Client.Models.Security.Artifact>(CustomGraph.Client.Models.Security.Artifact.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Security.Artifact>("artifact", Artifact);
