...
#nullable enable
        public CustomGraph.Client.Models.IdentitySet? ClosedBy { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.IdentitySet ClosedBy { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"closedBy", n => { ClosedBy = n.GetObjectValue<CustomGraph.Client.Models.IdentitySet>(CustomGraph.Client.Models.IdentitySet.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.IdentitySet>("closedBy", ClosedBy);
