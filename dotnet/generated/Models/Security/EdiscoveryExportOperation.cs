...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.Security.ExportFileMetadata>? ExportFileMetadata { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.Security.ExportFileMetadata> ExportFileMetadata { get; set; }
#endif
        ...
        public CustomGraph.Client.Models.Security.ExportOptions? ExportOptions { get; set; }
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"exportFileMetadata", n => { ExportFileMetadata = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.Security.ExportFileMetadata>(CustomGraph.Client.Models.Security.ExportFileMetadata.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.Security.ExportFileMetadata>("exportFileMetadata", ExportFileMetadata);
