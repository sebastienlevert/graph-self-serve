...
#nullable restore
        ...
        public CustomGraph.Client.Models.Security.DefenderAvStatus? DefenderAvStatus { get; set; }
...
#nullable restore
        ...
        public CustomGraph.Client.Models.Security.OnboardingStatus? OnboardingStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Security.VmMetadata? VmMetadata { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Security.VmMetadata VmMetadata { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"vmMetadata", n => { VmMetadata = n.GetObjectValue<CustomGraph.Client.Models.Security.VmMetadata>(CustomGraph.Client.Models.Security.VmMetadata.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Security.VmMetadata>("vmMetadata", VmMetadata);
        }
    }
}
