...
namespace CustomGraph.Client.Models.Security {
    public class FileEvidence : AlertEvidence, IParsable {
        ...
        public CustomGraph.Client.Models.Security.DetectionStatus? DetectionStatus { get; set; }
        /// <summary>The file details.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Security.FileDetails? FileDetails { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Security.FileDetails FileDetails { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"fileDetails", n => { FileDetails = n.GetObjectValue<CustomGraph.Client.Models.Security.FileDetails>(CustomGraph.Client.Models.Security.FileDetails.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Security.FileDetails>("fileDetails", FileDetails);
