...
#nullable enable
        public CustomGraph.Client.Models.Security.AutonomousSystem? AutonomousSystem { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Security.AutonomousSystem AutonomousSystem { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"autonomousSystem", n => { AutonomousSystem = n.GetObjectValue<CustomGraph.Client.Models.Security.AutonomousSystem>(CustomGraph.Client.Models.Security.AutonomousSystem.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Security.AutonomousSystem>("autonomousSystem", AutonomousSystem);
