...
#nullable enable
        public CustomGraph.Client.Models.Security.Host? Host { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Security.Host Host { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Security.SslCertificate? SslCertificate { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Security.SslCertificate SslCertificate { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"host", n => { Host = n.GetObjectValue<CustomGraph.Client.Models.Security.Host>(CustomGraph.Client.Models.Security.Host.CreateFromDiscriminatorValue); } },
                ...
                {"sslCertificate", n => { SslCertificate = n.GetObjectValue<CustomGraph.Client.Models.Security.SslCertificate>(CustomGraph.Client.Models.Security.SslCertificate.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Security.Host>("host", Host);
            writer.WriteDateTimeOffsetValue("lastSeenDateTime", LastSeenDateTime);
            writer.WriteCollectionOfObjectValues<HostSslCertificatePort>("ports", Ports);
            writer.WriteObjectValue<CustomGraph.Client.Models.Security.SslCertificate>("sslCertificate", SslCertificate);
        }
    }
}
