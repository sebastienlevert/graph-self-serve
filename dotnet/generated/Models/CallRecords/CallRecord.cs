...
namespace CustomGraph.Client.Models.CallRecords {
    public class CallRecord : CustomGraph.Client.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.IdentitySet? Organizer { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.IdentitySet Organizer { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.IdentitySet>? Participants { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.IdentitySet> Participants { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"organizer", n => { Organizer = n.GetObjectValue<CustomGraph.Client.Models.IdentitySet>(CustomGraph.Client.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                {"participants", n => { Participants = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.IdentitySet>(CustomGraph.Client.Models.IdentitySet.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.IdentitySet>("organizer", Organizer);
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.IdentitySet>("participants", Participants);
