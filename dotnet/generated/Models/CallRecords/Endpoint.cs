...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.CallRecords.UserAgent? UserAgent { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.CallRecords.UserAgent UserAgent { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"userAgent", n => { UserAgent = n.GetObjectValue<CustomGraph.Client.Models.CallRecords.UserAgent>(CustomGraph.Client.Models.CallRecords.UserAgent.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.CallRecords.UserAgent>("userAgent", UserAgent);
