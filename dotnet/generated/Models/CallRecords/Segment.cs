...
using System.Linq;
using System;
namespace CustomGraph.Client.Models.CallRecords {
    public class Segment : CustomGraph.Client.Models.Entity, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.CallRecords.FailureInfo? FailureInfo { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.CallRecords.FailureInfo FailureInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CustomGraph.Client.Models.CallRecords.Media>? Media { get; set; }
#nullable restore
#else
        public List<CustomGraph.Client.Models.CallRecords.Media> Media { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"failureInfo", n => { FailureInfo = n.GetObjectValue<CustomGraph.Client.Models.CallRecords.FailureInfo>(CustomGraph.Client.Models.CallRecords.FailureInfo.CreateFromDiscriminatorValue); } },
                {"media", n => { Media = n.GetCollectionOfObjectValues<CustomGraph.Client.Models.CallRecords.Media>(CustomGraph.Client.Models.CallRecords.Media.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.CallRecords.FailureInfo>("failureInfo", FailureInfo);
            writer.WriteCollectionOfObjectValues<CustomGraph.Client.Models.CallRecords.Media>("media", Media);
