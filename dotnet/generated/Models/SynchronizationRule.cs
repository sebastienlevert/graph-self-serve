...
#nullable enable
        public CustomGraph.Client.Models.ContainerFilter? ContainerFilter { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.ContainerFilter ContainerFilter { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.GroupFilter? GroupFilter { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.GroupFilter GroupFilter { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"containerFilter", n => { ContainerFilter = n.GetObjectValue<CustomGraph.Client.Models.ContainerFilter>(CustomGraph.Client.Models.ContainerFilter.CreateFromDiscriminatorValue); } },
                {"editable", n => { Editable = n.GetBoolValue(); } },
                {"groupFilter", n => { GroupFilter = n.GetObjectValue<CustomGraph.Client.Models.GroupFilter>(CustomGraph.Client.Models.GroupFilter.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.ContainerFilter>("containerFilter", ContainerFilter);
            writer.WriteBoolValue("editable", Editable);
            writer.WriteObjectValue<CustomGraph.Client.Models.GroupFilter>("groupFilter", GroupFilter);
