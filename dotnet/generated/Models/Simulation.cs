...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.EndUserNotificationSetting? EndUserNotificationSetting { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.EndUserNotificationSetting EndUserNotificationSetting { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.LandingPage? LandingPage { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.LandingPage LandingPage { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.LoginPage? LoginPage { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.LoginPage LoginPage { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.OAuthConsentAppDetail? OAuthConsentAppDetail { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.OAuthConsentAppDetail OAuthConsentAppDetail { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Payload? Payload { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Payload Payload { get; set; }
#endif
        ...
        public CustomGraph.Client.Models.PayloadDeliveryPlatform? PayloadDeliveryPlatform { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.TrainingSetting? TrainingSetting { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.TrainingSetting TrainingSetting { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"endUserNotificationSetting", n => { EndUserNotificationSetting = n.GetObjectValue<CustomGraph.Client.Models.EndUserNotificationSetting>(CustomGraph.Client.Models.EndUserNotificationSetting.CreateFromDiscriminatorValue); } },
                ...
                {"landingPage", n => { LandingPage = n.GetObjectValue<CustomGraph.Client.Models.LandingPage>(CustomGraph.Client.Models.LandingPage.CreateFromDiscriminatorValue); } },
                ...
                {"loginPage", n => { LoginPage = n.GetObjectValue<CustomGraph.Client.Models.LoginPage>(CustomGraph.Client.Models.LoginPage.CreateFromDiscriminatorValue); } },
                {"oAuthConsentAppDetail", n => { OAuthConsentAppDetail = n.GetObjectValue<CustomGraph.Client.Models.OAuthConsentAppDetail>(CustomGraph.Client.Models.OAuthConsentAppDetail.CreateFromDiscriminatorValue); } },
                {"payload", n => { Payload = n.GetObjectValue<CustomGraph.Client.Models.Payload>(CustomGraph.Client.Models.Payload.CreateFromDiscriminatorValue); } },
                ...
                {"trainingSetting", n => { TrainingSetting = n.GetObjectValue<CustomGraph.Client.Models.TrainingSetting>(CustomGraph.Client.Models.TrainingSetting.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.EndUserNotificationSetting>("endUserNotificationSetting", EndUserNotificationSetting);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.LandingPage>("landingPage", LandingPage);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.LoginPage>("loginPage", LoginPage);
            writer.WriteObjectValue<CustomGraph.Client.Models.OAuthConsentAppDetail>("oAuthConsentAppDetail", OAuthConsentAppDetail);
            writer.WriteObjectValue<CustomGraph.Client.Models.Payload>("payload", Payload);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.TrainingSetting>("trainingSetting", TrainingSetting);
        }
    }
}
