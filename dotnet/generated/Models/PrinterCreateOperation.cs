...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.Printer? Printer { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.Printer Printer { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"printer", n => { Printer = n.GetObjectValue<CustomGraph.Client.Models.Printer>(CustomGraph.Client.Models.Printer.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.Printer>("printer", Printer);
        }
    }
}
