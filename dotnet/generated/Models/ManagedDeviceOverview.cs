...
#nullable enable
        public CustomGraph.Client.Models.DeviceExchangeAccessStateSummary? DeviceExchangeAccessStateSummary { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.DeviceExchangeAccessStateSummary DeviceExchangeAccessStateSummary { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.DeviceOperatingSystemSummary? DeviceOperatingSystemSummary { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.DeviceOperatingSystemSummary DeviceOperatingSystemSummary { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"deviceExchangeAccessStateSummary", n => { DeviceExchangeAccessStateSummary = n.GetObjectValue<CustomGraph.Client.Models.DeviceExchangeAccessStateSummary>(CustomGraph.Client.Models.DeviceExchangeAccessStateSummary.CreateFromDiscriminatorValue); } },
                {"deviceOperatingSystemSummary", n => { DeviceOperatingSystemSummary = n.GetObjectValue<CustomGraph.Client.Models.DeviceOperatingSystemSummary>(CustomGraph.Client.Models.DeviceOperatingSystemSummary.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.DeviceExchangeAccessStateSummary>("deviceExchangeAccessStateSummary", DeviceExchangeAccessStateSummary);
            writer.WriteObjectValue<CustomGraph.Client.Models.DeviceOperatingSystemSummary>("deviceOperatingSystemSummary", DeviceOperatingSystemSummary);
