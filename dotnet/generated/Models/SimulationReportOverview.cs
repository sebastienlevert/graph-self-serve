...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.SimulationEventsContent? SimulationEventsContent { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.SimulationEventsContent SimulationEventsContent { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.TrainingEventsContent? TrainingEventsContent { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.TrainingEventsContent TrainingEventsContent { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"simulationEventsContent", n => { SimulationEventsContent = n.GetObjectValue<CustomGraph.Client.Models.SimulationEventsContent>(CustomGraph.Client.Models.SimulationEventsContent.CreateFromDiscriminatorValue); } },
                {"trainingEventsContent", n => { TrainingEventsContent = n.GetObjectValue<CustomGraph.Client.Models.TrainingEventsContent>(CustomGraph.Client.Models.TrainingEventsContent.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.SimulationEventsContent>("simulationEventsContent", SimulationEventsContent);
            writer.WriteObjectValue<CustomGraph.Client.Models.TrainingEventsContent>("trainingEventsContent", TrainingEventsContent);
