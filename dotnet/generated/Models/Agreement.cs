...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.TermsExpiration? TermsExpiration { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.TermsExpiration TermsExpiration { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"termsExpiration", n => { TermsExpiration = n.GetObjectValue<CustomGraph.Client.Models.TermsExpiration>(CustomGraph.Client.Models.TermsExpiration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.TermsExpiration>("termsExpiration", TermsExpiration);
