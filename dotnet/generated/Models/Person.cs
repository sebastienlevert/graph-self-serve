...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.PersonType? PersonType { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.PersonType PersonType { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"personType", n => { PersonType = n.GetObjectValue<CustomGraph.Client.Models.PersonType>(CustomGraph.Client.Models.PersonType.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.PersonType>("personType", PersonType);
