...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.FileHash? FileHash { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.FileHash FileHash { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"fileHash", n => { FileHash = n.GetObjectValue<CustomGraph.Client.Models.FileHash>(CustomGraph.Client.Models.FileHash.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.FileHash>("fileHash", FileHash);
