...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.DriveItemSource? DriveItemSource { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.DriveItemSource DriveItemSource { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CustomGraph.Client.Models.MediaSource? MediaSource { get; set; }
#nullable restore
#else
        public CustomGraph.Client.Models.MediaSource MediaSource { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"driveItemSource", n => { DriveItemSource = n.GetObjectValue<CustomGraph.Client.Models.DriveItemSource>(CustomGraph.Client.Models.DriveItemSource.CreateFromDiscriminatorValue); } },
                ...
                {"mediaSource", n => { MediaSource = n.GetObjectValue<CustomGraph.Client.Models.MediaSource>(CustomGraph.Client.Models.MediaSource.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.DriveItemSource>("driveItemSource", DriveItemSource);
            ...
            writer.WriteObjectValue<CustomGraph.Client.Models.MediaSource>("mediaSource", MediaSource);
