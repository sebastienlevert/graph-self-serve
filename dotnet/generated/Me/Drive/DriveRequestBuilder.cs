...
using System;
namespace CustomGraph.Client.Me.Drive {
    /// <summary>
    ...
    public class DriveRequestBuilder : BaseRequestBuilder {
        ...
        /// </summary>
        /// <returns>A <see cref="CustomGraph.Client.Models.Drive"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="ODataError">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<CustomGraph.Client.Models.Drive?> GetAsync(Action<RequestConfiguration<DriveRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CustomGraph.Client.Models.Drive> GetAsync(Action<RequestConfiguration<DriveRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<CustomGraph.Client.Models.Drive>(requestInfo, CustomGraph.Client.Models.Drive.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve the properties and relationships of a Drive resource. A Drive is the top-level container for a file system, such as OneDrive or SharePoint document libraries.
        /// </summary>
