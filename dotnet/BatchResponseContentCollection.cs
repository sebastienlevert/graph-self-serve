namespace Microsoft.Graph
{
    ...
    /// </summary>
    public class BatchResponseContentCollectionCustom
    {
        private readonly List<KeyedBatchResponseContentCustom> batchResponses;

        internal BatchResponseContentCollectionCustom()
        {
            batchResponses = new List<KeyedBatchResponseContentCustom>();
        }

        internal void AddResponse(IEnumerable<string> keys, BatchResponseContent content)
        {
            batchResponses.Add(new KeyedBatchResponseContentCustom(new HashSet<string>(keys), content));
        }
